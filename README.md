...
![Baseline Model](images/baseline_curves.png)
...
საბოლოოდ, ყველაზე კარგი მოდელი გამოვიდა D) CNN + Attention Layers. ეს გასაკვირი არცაა, ყველაზე კომპლექსური მოდელია, რაც გამოვიყენე. თუმცა დიდი გაუმჯობესება არ ყოფილა, მხოლოდ CNN-ებიანი მოდელიც 60%-ზე ადიოდა,
ამან მხოლოდ 5%-ით გააუმჯობესა. მე ამ ამოცანისთვის B მოდელს გამოვიყენებდი, ყველაზე შესაფერისია ამ დავალებისთვის, Attention-ის დამატება overkill მგონია უბრალოდ.